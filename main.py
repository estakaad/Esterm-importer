...
# output_json = 'files/import/esterm-10-01-2024/eksperdid.json'
# expert_info_from_esterm = 'files/input/eksperdid_estermist.csv'
# expert_info_for_api_calls = 'files/import/esterm-10-01-2024/eksperdid_sources_without_ids.json'
#
...
requests_concepts.update_word_ids(concepts_without_word_ids_file, 'eki', 'est1001',
...
concepts_with_word_ids = 'files/import/esterm-11-01-2024/concepts_with_word_ids.json'
saved_concepts_filename = f'files/import/esterm-11-01-2024/concepts_saved.json'
not_saved_concepts_filename = f'files/import/esterm-11-01-2024/concepts_not_saved.json'

requests_concepts.import_concepts(concepts_with_word_ids, 'est', saved_concepts_filename,

...
# 1. First parse XML and find potential expert names. Then create sources for these experts
# 13 sec
#expert_sources = parse_sources.create_expert_sources(esterm_filename)

# 2. Export sources from XML input/esterm.xml. Add expert sources to it as well.

...
def create_json(conceptGrp):
    ...
    # Sort objects of type 'SOURCE_NAME' in ascending order by the lentgh of the key value
...
# Parse Esterm XML, filter out sources and transform them to JSON objects. Return output/sources.json

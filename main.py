...
# 1. Export sources from XML input/esterm.xml. Returns sources files/output/sources.json
...
#requests_sources.assign_ids_to_all_sources('files/output/sources.json')

# 3. Export concepts from XML. Returns files/output/concepts.json and files/output/aviation_concepts.json
#parse_concepts.transform_esterm_to_json()

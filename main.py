...
#updated_sources_file = requests_sources.assign_ids_to_all_sources('files/output/sources.json')

# 3. Export concepts from XML. Returns files/output/concepts.json and files/output/aviation_concepts.json
with open('files/output/sources_with_ids-backup.json', 'r', encoding='utf-8') as f:
